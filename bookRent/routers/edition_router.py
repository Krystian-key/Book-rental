...
def get_all(db: Session = Depends(get_db)):
    return try_perform(get_all_editions, db=db)
...
def get_by_edition_num(num: int, db: Session = Depends(get_db)):
    return try_perform(get_editions_by_edition_number, num, db=db)
...
def get_by_original_series(series: str, db: Session = Depends(get_db)):
    return try_perform(get_editions_by_original_series, series, db=db)
...
def get_by_author_name(name: str, db: Session = Depends(get_db)):
    return try_perform(get_editions_by_author_name, name, db=db)
...
def get_by_author_surname(surname: str, db: Session = Depends(get_db)):
    return try_perform(get_editions_by_author_surname, surname, db=db)
...
def get_by_author_birth_year(birth: int, db: Session = Depends(get_db)):
    return try_perform(get_editions_by_author_birth_year, birth, db=db)
...
def get_by_author_death_year(death: int, db: Session = Depends(get_db)):
    return try_perform(get_editions_by_author_death_year, death, db=db)
...
def get_by_author_name(name: str, db: Session = Depends(get_db)):
    return try_perform(get_editions_by_illustrator_name, name, db=db)
...
def get_by_illustrator_surname(surname: str, db: Session = Depends(get_db)):
    return try_perform(get_editions_by_illustrator_surname, surname, db=db)
...
def get_by_illustrator_birth_year(birth: int, db: Session = Depends(get_db)):
    return try_perform(get_editions_by_illustrator_birth_year, birth, db=db)
...
def get_by_illustrator_death_year(death: int, db: Session = Depends(get_db)):
    return try_perform(get_editions_by_illustrator_death_year, death, db=db)
...
def get_by_translator_name(name: str, db: Session = Depends(get_db)):
    return try_perform(get_editions_by_translator_name, name, db=db)
...
def get_by_translator_surname(surname: str, db: Session = Depends(get_db)):
    return try_perform(get_editions_by_translator_surname, surname, db=db)
...
def get_by_translator_birth_year(birth: int, db: Session = Depends(get_db)):
    return try_perform(get_editions_by_translator_birth_year, birth, db=db)
...
def get_by_translator_death_year(death: int, db: Session = Depends(get_db)):
    return try_perform(get_editions_by_translator_death_year, death, db=db)
...
def get_by_publisher_city(city: str, db: Session = Depends(get_db)):
    return try_perform(get_editions_by_publisher_city, city, db=db)
...
def get_by_publisher_foundation_year(year: int, db: Session = Depends(get_db)):
    return try_perform(get_editions_by_publisher_foundation_year, year, db=db)
